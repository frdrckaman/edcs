...
list_data = {
    ...
    "edcs_lists.immunohistochemistry": [
        ...
        (POS_VIMENTIN, "Vimentin"),
        (POS_PDL1, "PDL1"),
        (POS_EGFR, "EGFR"),
        (POS_SYNAPTOPHYSIN, "Synaptophysin"),
        (POS_HER2, "HER2"),
        (POS_CHROMOGRANIN_A, "Chromogranin A"),
        (POS_Ki67_50_60, "Ki67 (50-60%)"),
        (POS_CALRETININ, "Calretinin"),
        (POS_NAPSIN_A, "Napsin A"),
        (POS_ROS1, "ROS1"),
        (POS_ALK, "ALK"),
        (POS_CD56, "CD56"),
        (NEG, "Negative"),
