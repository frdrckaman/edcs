# Generated by Django 3.1.7 on 2022-01-07 12:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appt_status', models.CharField(choices=[('new', 'New'), ('in_progress', 'In Progress'), ('incomplete', 'Incomplete'), ('done', 'Done'), ('cancelled', 'Cancelled')], db_index=True, default='new', help_text="If the visit has already begun, only 'in progress', 'incomplete' or 'done' are valid options", max_length=25, verbose_name='Status')),
