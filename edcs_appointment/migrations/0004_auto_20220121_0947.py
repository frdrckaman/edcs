...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('edcs_appointment', '0003_auto_20220120_1609'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('new', 'New'), ('start', 'Start'), ('open', 'Open'), ('incomplete', 'Incomplete'), ('closed', 'Closed')], max_length=15, null=True),
        ),
        migrations.AlterField(
