...
class ExclusionCriteria(BaseUuidModel):
    ...
    products = models.CharField('Use of immunoglobulins or blood products', max_length=1, choices=yes_no_choices,
                                help_text='(e.g., blood transfusion) at any time in the past')

    vaccine14 = models.CharField('Receipt of any vaccine in the 14 days preceding enrolment, or planned receipt of any\
                                  other vaccine within 14 days following each vaccination',
                                 max_length=1, choices=yes_no_choices
                                )

    vaccine30 = models.CharField('Receipt of an investigational product in the 30 days preceding \
                                          enrolment, or planned receipt during the study period',
                                    max_length=1, choices=yes_no_choices
                                )
    concurrent = models.CharField(max_length=1, choices=yes_no_choices,
                                verbose_name='Concurrent involvement in another clinical trial or planned involvement '
...
class ScreeningTwo(BaseUuidModel):
    ...
    medication = models.CharField(max_length=1, choices=yes_no_choices,
                               verbose_name='Is the participant currently taking new medications not previously noted?')
