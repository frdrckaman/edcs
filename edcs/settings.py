...
EDCS_DATA_DICTIONARY = env.str("EDCS_DATA_DICTIONARY")

EXPORT_DATA = env.str("EXPORT_DATA")

EDCS_DATA_DOWNLOAD = env.str("EDCS_DATA_DOWNLOAD")

EDCS_DATA_NAME = env.str("EDCS_DATA_NAME")

EDCS_DICT_NAME = env.str("EDCS_DICT_NAME")
