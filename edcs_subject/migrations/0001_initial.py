    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('how_long_work_mine', models.CharField(choices=[('less_than_5yrs', '≤ 5 years'), ('greater_than_5yrs', '≥ 5 years'), ('N/A', 'Not applicable')], max_length=45, verbose_name='If yes, for how long have worked in the mines?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
                ('report_datetime', models.DateTimeField(default=edcs_utils.date.get_utcnow, help_text='Date and time of report.', verbose_name='Report Date and Time')),
                ('lung_cancer_stage', models.CharField(choices=[('one', 'One (1)'), ('two', 'Two (2)'), ('three', 'Three (3)'), ('four', 'Four (4)'), ('N/A', 'Not applicable')], max_length=45, verbose_name='What is the stage of lung cancer?')),
