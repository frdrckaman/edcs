# Generated by Django 3.1.7 on 2021-11-19 12:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hiv_dx', models.CharField(blank=True, choices=[('POS', 'HIV Positive '), ('NEG', 'HIV Negative'), ('decline_to_answer', 'Decline to answer'), ('dont_know', 'I dont know')], max_length=45, null=True, verbose_name='What was the result of your most recent HIV test?')),
                ('arv', models.CharField(blank=True, choices=[('POS', 'HIV Positive '), ('NEG', 'HIV Negative'), ('decline_to_answer', 'Decline to answer'), ('dont_know', 'I dont know')], max_length=45, null=True, verbose_name='If positive, are you taking ARVs?')),
                ('arv_start_date', models.DateField(blank=True, null=True, verbose_name='Month and year patient started taking ARVs?')),
                ('arv_regularly', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, null=True, verbose_name='Do you take your ARVs regularly? ')),
                ('miss_taking_arv', models.CharField(blank=True, choices=[('at_least_once_every_week', 'At least once every week'), ('at_least_once_a_month', 'At least once in a month'), ('at_least_once_3_months', 'At least once in 3 months'), ('at_least_once_a_year', 'At least once a year'), ('dont_remember', 'I Do not remember'), ('others', 'Other')], max_length=45, null=True, verbose_name='If no, how often do you miss taking ARVs?')),
                ...
                ('lung_diseases_date', models.DateField(blank=True, null=True, verbose_name='If yes, when were you diagnosed?')),
                ('use_lung_diseases_medication', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=80, null=True, verbose_name='Are you using any medications?')),
                ...
                ('use_htn_medication', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=45, verbose_name='Have you ever been diagnosed with Hypertension?')),
                ('htn_medication', models.TextField(blank=True, null=True, verbose_name='If is yes, what medications are you using currently?')),
                ...
                ('use_dm_medication', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=45, verbose_name='Have you ever been diagnosed with Hypertension?')),
                ('dm_medication', models.TextField(blank=True, null=True, verbose_name='If is yes, what medications are you using currently?')),
                ('malignancy', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer'), ('dont_know', 'Do not know')], max_length=45, verbose_name='Have you ever had any other malignancy?')),
                ('tb_test', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Were you tested for TB?')),
                ('provide_sputum_tb_dx', models.CharField(choices=[('yes', 'Yes'), ('no_declined', 'No, declined'), ('no_sputum', 'No sputum')], max_length=45, verbose_name='If No, has the patient provided sputum for TB diagnosis?')),
                ('tb_status', models.CharField(choices=[('tb_positive', 'TB positive'), ('tb_negative', 'TB negative (No TB)'), ('inconclusive_results', 'Inconclusive results')], max_length=45, verbose_name='What is the patients TB status?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('covid_symptoms', models.CharField(choices=[('headache', 'Headache'), ('fever', 'Fever'), ('muscle_ache', 'Muscle ache'), ('weakness_tiredness', 'Weakness/tiredness '), ('nausea_vomiting', 'Nausea/vomiting'), ('abdominal_pain', 'Abdominal pain'), ('diarrhea', 'Diarrhea'), ('sore_throat', 'Sore throat'), ('cough', 'Cough'), ('shortness_of_breath', 'Shortness of breath'), ('loss_taste', 'Loss of taste'), ('no_loss_smell', 'No Loss of smell')], max_length=45, verbose_name='If yes, what symptoms did you have when you first had COVID-19?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industries_worked_on', models.CharField(choices=[('textile_industry', 'Textile industry'), ('chemical_production_industry', 'Chemical production industry'), ('food_processing_industry', 'Food processing industry'), ('drug_industry', 'Drug industry'), ('milling_industry', 'Milling industry'), ('construction_industry', 'Construction industry'), ('other', 'Other')], max_length=45, verbose_name='If yes, what kind of industry did you work?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family_member_dx_cancer', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('family_history_unknown', 'Family history unknown')], max_length=45, verbose_name='Has any member of your family been diagnosed with either breast cancer, colon cancer, lung cancer, ovarian cancer, prostate cancer, thyroid or uterine cancer?')),
