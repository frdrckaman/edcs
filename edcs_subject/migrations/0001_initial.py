# Generated by Django 3.1.7 on 2022-02-09 13:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('characterize_symptoms', models.CharField(choices=[('', 'Sudden onset'), ('', 'Gradual onset'), ('', 'Progressive in severity'), ('', 'Intermittent in severity'), ('other', 'Others')], max_length=45, verbose_name='How would you characterize your symptoms?')),
                ...
                ('chest_radiation', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=45, null=True, verbose_name='')),
                ('no_chest_radiation', models.IntegerField(verbose_name='If yes, how many times?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industries_worked', models.CharField(choices=[('textile_industry', 'Textile industry'), ('chemical_production_industry', 'Chemical production industry'), ('food_processing_industry', 'Food processing industry'), ('drug_industry', 'Drug industry'), ('milling_industry', 'Milling industry'), ('construction_industry', 'Construction industry'), ('other', 'Other')], max_length=45, verbose_name='If yes, what kind of industry did you work?')),
                ...
                ('how_long_work_mine', models.CharField(choices=[('less_than_5yrs', '≤ 5 years'), ('greater_than_5yrs', '≥ 5 years')], max_length=45, verbose_name='If yes, for how long have worked in the mines?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(editable=False, max_length=10, null=True)),
                ('report_datetime', models.DateTimeField(default=edcs_utils.date.get_utcnow, help_text='Date and time of report.', verbose_name='Report Date and Time')),
                ('lung_cancer_stage', models.CharField(choices=[('one', 'One (1)'), ('two', 'Two (2)'), ('three', 'Three (3)'), ('four', 'Four (4)')], max_length=45, verbose_name='What is the stage of lung cancer?')),
                ('date_start_treatment', models.DateField(max_length=45, verbose_name='Date started Treatment?')),
                ('treatment', models.CharField(choices=[('chemotherapy', 'Chemotherapy'), ('radiation', 'Radiation'), ('surgical_resection', 'Surgical resection'), ('immunotherapy', 'Immunotherapy'), ('tyrosine_kinase_inhibitor', 'Tyrosine kinase inhibitor '), ('1_2above', '1 & 2 above'), ('other', 'Others')], max_length=45, verbose_name='Type of treatment?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baseline_cd4', models.IntegerField(verbose_name='Baseline CD4 counts')),
                ('baseline_viral_load', models.IntegerField(verbose_name='Baseline Viral Load')),
                ('hiv_stage', models.CharField(choices=[('one', 'One (1)'), ('two', 'Two (2)'), ('three', 'Three (3)'), ('four', 'Four (4)')], max_length=45, verbose_name='What is the patient HIV stage?')),
                ('hiv_subtype_done', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Was the patient’s HIV subtype done?')),
                ('hiv_subtype', models.CharField(choices=[('a', 'A'), ('b', 'B'), ('c', 'C')], max_length=45, verbose_name='Was the patient’s HIV subtype done?')),
                ('drug_resistance_testing_done', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Was the patient’s HIV subtype done?')),
        ...
        migrations.CreateModel(
            name='HistoricalHomeLocatorForm',
            fields=[
                ('revision', django_revision.revision_field.RevisionField(blank=True, editable=False, help_text='System field. Git repository tag:branch:commit.', max_length=75, null=True, verbose_name='Revision')),
                ('created', models.DateTimeField(blank=True, default=django_audit_fields.models.audit_model_mixin.utcnow)),
                ('modified', models.DateTimeField(blank=True, default=django_audit_fields.models.audit_model_mixin.utcnow)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('who_had_illness', models.CharField(choices=[('child', 'Child'), ('husband', 'Husband'), ('wife', 'Wife'), ('other_member_household', 'Other member of the house hold')], max_length=45, verbose_name='If yes, please state, who had the illness')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.DateField(choices=[('never_been_in_school', 'Never been in school'), ('primary_education', 'Completed Primary Education'), ('secondary_education', 'Completed Secondary Education (‘’O’’ or ‘’A’’ level)'), ('vocational_training', 'Vocational training'), ('tertiary_education', 'Tertiary Education'), ('others', 'Other')], max_length=45, verbose_name='Education level?')),
                ...
                ('occupation', models.CharField(choices=[('civil_servant', 'Civil Servant'), ('house_wife', 'House wife'), ('peasant', 'Peasant'), ('petty_trader', 'Petty trader'), ('entrepreneur', 'Entrepreneur'), ('unemployed', 'Unemployed'), ('business_man', 'Business man/woman'), ('others', 'Other')], max_length=45, verbose_name='Occupation')),
                ...
                ('material_build_roof', models.CharField(choices=[('soil_sand_mud', 'Iron sheet/roofing tiles'), ('grass_leaves_soil', 'Grass/ leaves/ palm leaves/ soil'), ('other_materials', 'Other materials')], max_length=45, verbose_name='Which materials were used for roofing your house?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_think_had_covid', models.DateField(max_length=45, verbose_name='If yes, On what date did you first know or think you had COVID-19?')),
                ('have_covid_symptoms', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Did you have any symptoms when you first knew or thought you had COVID-19?')),
                ('admitted_hospital', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Were you admitted to hospital when you thought you had COVID-19? ')),
                ...
                ('swab_test_results', models.CharField(choices=[('positive_test', 'One or more positive test(s) '), ('negative_more_positive', 'One or more negative tests, but none were positive'), ('all_test_failed', 'All tests failed'), ('waiting_results', 'Waiting for all results')], max_length=45, verbose_name='If yes, What was the result/were the results of all swab tests you’ve had?')),
                ('date_first_positive_test', models.DateField(max_length=45, verbose_name='If any positive test: What was the date of first positive test you’ve had?')),
                ('date_last_negative_test', models.DateField(max_length=45, verbose_name='If all tests negative: What was the date of last negative test you’ve had?')),
                ...
                ('covid_vaccine', models.CharField(choices=[('dont_know_type', 'Don’t know type'), ('pfizer_biontech_moderna', 'Pfizer/BioNTech Moderna'), ('oxford_astraZeneca', 'Oxford/AstraZeneca'), ('janssen_johnson_Johnson', 'Janssen\\Johnson&Johnson'), ('novavax', 'Novavax'), ('sinovac', 'Sinovac'), ('sputnik', 'Sputnik'), ('valneva', 'Valneva'), ('sinopharm', 'Sinopharm')], max_length=45, verbose_name='If yes, what type of vaccination')),
                ('vaccine_provider', models.CharField(choices=[('government_uganda', 'Government of Uganda'), ('research_study', 'Research study/trial '), ('other', 'Others')], max_length=45, verbose_name='If Yes who provided the vaccine')),
                ...
                ('no_covid_vaccine', models.CharField(choices=[('one', 'One'), ('two', 'Two'), ('three_more', 'Three or More')], max_length=45, verbose_name='How many doses have you received to date?')),
                ('date_recent_vaccination', models.DateField(max_length=45, verbose_name='Date of most recent vaccination?')),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_wood_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use wood per month?')),
                ('use_kerosene', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use kerosene to cook?')),
                ('use_kerosene_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use kerosene per month?')),
                ('use_charcoal', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use charcoal to cook?')),
                ('use_charcoal_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use charcoal per month?')),
                ('use_coal', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use coal/ignite to cook')),
                ('use_coal_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use coal/ignite per month?')),
                ('use_straw', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use straw/shrubs/grass to cook?')),
                ('use_straw_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use straw/shrubs/grass per month?')),
                ('use_electricity', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use electricity to cook?')),
                ('use_electricity_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use electricity per month?')),
                ('use_biogas', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use biogas for cook?')),
                ('use_biogas_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use biogas per month?')),
                ('use_dung', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use animal dung to cook?')),
                ('use_dung_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use animal dung per month?')),
                ('use_paper', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use paper to cook?')),
                ('use_paper_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use paper per month?')),
                ('use_polythene', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=45, verbose_name='Do you use polythene to cook?')),
                ('use_polythene_per_month', models.CharField(choices=[('25_days_month', 'At least 25% of the days in a month'), ('25_50_days_month', '25%-50% of the days in a month'), ('50_70_days_month', '50-75% of the days in a month'), ('75_100_days_month', '75%-100% of the days in a month')], max_length=45, verbose_name='If yes, how many times do you use polythene per month?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('report_datetime', models.DateTimeField(default=edcs_utils.date.get_utcnow, help_text='Date and time of report.', verbose_name='Report Date and Time')),
                ('age_attain_menarche', models.CharField(choices=[('less_than_12yrs', '≤ 12 years'), ('12_13yrs', '12-13 years'), ('14_15yrs', '14-15 years'), ('greater_than_16yrs', '≥ 16 years')], max_length=45, verbose_name='At what age did you attain your menarche?')),
                ('age_have_first_child', models.CharField(choices=[('nulliparous', 'Nulliparous'), ('less_than_20yrs', '≤ 20years'), ('20_29yrs', '20-29 years'), ('30_39yrs', '30-39 years'), ('greater_than_39yrs', '≥ 39 years')], max_length=45, verbose_name='At what age did you have your first child?')),
                ('age_have_last_child', models.CharField(choices=[('nulliparous', 'Nulliparous'), ('less_than_25yrs', '≤ 25years'), ('25_29_yrs', '25-29 years'), ('30_39yrs', '30-39 years'), ('greater_than_39yrs', '≥ 39 years')], max_length=45, verbose_name='At what age did you have your last child?')),
                ('breast_feed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=45, verbose_name='Have you ever breast fed?')),
                ('use_oral_contraceptives', models.CharField(choices=[('yes_current_user', 'Yes, Current user'), ('yes_past_user', 'Yes, Past user'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=45, verbose_name='Have you ever used oral contraceptives?')),
                ('how_long_use_oral_contraceptives', models.CharField(choices=[('less_than_5yrs', '≤ 5 years'), ('greater_than_5yrs', '≥ 5 years')], max_length=45, verbose_name='If yes, how long have you been using oral contraceptives?')),
                ('when_stop_use_contraceptives', models.CharField(choices=[('less_than_5yrs_ago', '≤ 5 years ago'), ('greater_than_5yrs_ago', '≥ 5 years ago')], max_length=45, verbose_name='For those who have stopped using oral contraceptive, when did you stop?')),
                ('post_menopausal_hormone_therapy', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=45, verbose_name='Have you ever used post-menopausal hormone therapy?')),
                ('how_long_post_menopausal_hormone_therapy', models.CharField(choices=[('less_than_5yrs', '≤ 5 years'), ('greater_than_5yrs', '≥ 5 years')], max_length=45, verbose_name='If yes, how long have you been using/ have you used post-menopausal therapy? ')),
                ('how_long_stop_post_menopausal_hormone_therapy', models.CharField(choices=[('less_than_5yrs_ago', '≤ 5 years ago'), ('greater_than_5yrs_ago', '≥ 5 years ago')], max_length=45, verbose_name='For those who have stopped using post-menopausal hormone therapy, when did you stop using post-menopausal therapy?')),
                ('age_attain_menopause', models.CharField(choices=[('less_than_46yrs', '≤ 46 years'), ('46_50yrs', '46-50 years'), ('greater_than_51yrs', '≥ 51 years')], max_length=45, verbose_name='For menopausal women, at what age did you attain menopause?')),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hiv_dx', models.CharField(choices=[('POS', 'HIV Positive '), ('NEG', 'HIV Negative'), ('decline_to_answer', 'Decline to answer'), ('dont_know', 'I dont know')], default=None, max_length=45, verbose_name='What was the result of your most recent HIV test?')),
                ('arv', models.CharField(choices=[('POS', 'HIV Positive '), ('NEG', 'HIV Negative'), ('decline_to_answer', 'Decline to answer'), ('dont_know', 'I dont know')], default=None, max_length=45, verbose_name='If positive, are you taking ARVs?')),
                ('arv_start_date', models.DateField(blank=True, null=True, verbose_name='Month and year patient started taking ARVs?')),
                ('arv_regularly', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=15, verbose_name='Do you take your ARVs regularly? ')),
                ...
                ('use_lung_diseases_medication', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], default=None, max_length=80, verbose_name='Are you using any medications?')),
                ...
                ('use_htn_medication', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=45, verbose_name='Are you using any medications?')),
                ...
                ('use_dm_medication', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('decline_to_answer', 'Decline to answer')], max_length=45, verbose_name='Are you using any medications?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('breast_cancer', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=25, verbose_name='Breast Cancer')),
                ('breast_cancer_age_dx', models.IntegerField(verbose_name='Indicate age of diagnosis')),
                ...
                ('colon_cancer', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=25, verbose_name='Colon Cancer')),
                ('colon_cancer_age_dx', models.IntegerField(verbose_name='Indicate age of diagnosis')),
                ...
                ('lung_cancer', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=25, verbose_name='Lung Cancer')),
                ('lung_cancer_age_dx', models.IntegerField(verbose_name='Indicate age of diagnosis')),
                ...
                ('ovarian_cancer', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=25, verbose_name='Ovarian Cancer')),
                ('ovarian_cancer_age_dx', models.IntegerField(verbose_name='Indicate age of diagnosis')),
                ...
                ('prostate_cancer', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=25, verbose_name='Prostate Cancer')),
                ('prostate_cancer_age_dx', models.IntegerField(verbose_name='Indicate age of diagnosis')),
                ...
                ('thyroid_cancer', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=25, verbose_name='Thyroid Cancer')),
                ('thyroid_cancer_age_dx', models.IntegerField(verbose_name='Indicate age of diagnosis')),
                ...
                ('uterine_cancer', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default=None, max_length=25, verbose_name='Uterine Cancer')),
                ('uterine_cancer_age_dx', models.IntegerField(verbose_name='Indicate age of diagnosis')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tobacco_product', models.DateField(choices=[('yes_cigarettes', 'Yes, Cigarettes'), ('yes_cigars', 'Yes, Cigars'), ('yes_shisha', 'Yes, Shisha'), ('yes_pipes', 'Yes, pipes'), ('none_of_above', 'None of the above')], max_length=45, verbose_name='If currently/past smoker, which tobacco products do you/ did you smoke.')),
                ...
                ('smoking_frequency', models.CharField(choices=[('daily', 'Daily'), ('every_other_day', 'Every other day'), ('weekly', 'Weekly (Not daily)'), ('monthly', 'Monthly(Not weekly)'), ('others', 'Others')], max_length=45, verbose_name='How frequently do you smoke these products?')),
                ...
                ('no_tobacco_product_smoked', models.IntegerField(verbose_name='On average, how many of these products do you/did you smoke?')),
                ('age_start_smoking', models.IntegerField(help_text='in years', verbose_name='If past smoker, at what age did you first start smoking?')),
                ('age_stop_smoking', models.IntegerField(help_text='in years', verbose_name='If past smoker, at what age did you stop smoking?')),
                ...
                ('smoke_inside_house', models.CharField(choices=[('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly'), ('less_than_monthly', 'Less than monthly'), ('never', 'Never'), ('others', 'Others')], max_length=45, verbose_name='How often does anyone smoke inside your house?')),
                ...
                ('alcohol_consumption_frequency', models.CharField(choices=[('daily', '1-Daily'), ('every_other_day', 'Every other day'), ('weekly', 'Weekly (Not daily )'), ('monthly', 'Monthly (Not weekly)'), ('others', 'Others')], max_length=45, verbose_name='How frequently do you consume alcohol?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distance_health_facility', models.IntegerField(help_text='(in km)', verbose_name='Distance from patient’s home to the health facility')),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_covid_vaccine', models.CharField(choices=[('one', 'One'), ('two', 'Two'), ('three_more', 'Three or More')], max_length=45, verbose_name='How many doses have you received to date?')),
                ('date_recent_vaccination', models.DateField(max_length=45, verbose_name='Date of most recent vaccination?')),
                ('covid_symptoms', models.ManyToManyField(related_name='covid_symptoms', to='edcs_lists.CovidSymptoms', verbose_name='If yes, what symptoms did you have when you first had COVID-19?')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.site')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='edcs_subject.subjectvisit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uterine_cancer_age_dx', models.IntegerField(verbose_name='Indicate age of diagnosis')),
                ('uterine_cancer_family_member_other', edcs_model.models.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ('breast_cancer_family_member', models.ManyToManyField(related_name='breast_cancer_family_member', to='edcs_lists.FamilyMembers', verbose_name='What is your relationship?')),
                ('colon_cancer_family_member', models.ManyToManyField(related_name='colon_cancer_family_member', to='edcs_lists.FamilyMembers', verbose_name='What is your relationship?')),
                ('lung_cancer_family_member', models.ManyToManyField(related_name='lung_cancer_family_member', to='edcs_lists.FamilyMembers', verbose_name='What is your relationship?')),
                ('ovarian_cancer_family_member', models.ManyToManyField(related_name='ovarian_cancer_family_member', to='edcs_lists.FamilyMembers', verbose_name='What is your relationship?')),
                ('prostate_cancer_family_member', models.ManyToManyField(related_name='prostate_cancer_family_member', to='edcs_lists.FamilyMembers', verbose_name='What is your relationship?')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.site')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='edcs_subject.subjectvisit')),
                ('thyroid_cancer_family_member', models.ManyToManyField(related_name='thyroid_cancer_family_member', to='edcs_lists.FamilyMembers', verbose_name='What is your relationship?')),
                ('uterine_cancer_family_member', models.ManyToManyField(related_name='uterine_cancer_family_member', to='edcs_lists.FamilyMembers', verbose_name='What is your relationship?')),
            ],
            options={
