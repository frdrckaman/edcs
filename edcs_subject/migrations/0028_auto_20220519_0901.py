# Generated by Django 3.1.7 on 2022-05-19 09:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('edcs_subject', '0027_auto_20220518_1542'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='demographiccharacteristic',
            options={'default_permissions': ('add', 'change', 'delete', 'view', 'export', 'import'), 'get_latest_by': 'modified', 'ordering': ('-modified', '-created'), 'verbose_name': 'Demographic', 'verbose_name_plural': 'Demographic'},
        ),
        migrations.AlterModelOptions(
            name='historicaldemographiccharacteristic',
            options={'get_latest_by': 'history_date', 'ordering': ('-history_date', '-history_id'), 'verbose_name': 'historical Demographic'},
        ),
        ...
        migrations.RemoveField(
            model_name='demographiccharacteristic',
            name='material_build_floor_other',
        ),
        migrations.RemoveField(
            model_name='demographiccharacteristic',
        ...
        migrations.RemoveField(
            model_name='demographiccharacteristic',
            name='material_build_roof_other',
        ),
        migrations.RemoveField(
            model_name='demographiccharacteristic',
        ...
        migrations.RemoveField(
            model_name='demographiccharacteristic',
            name='material_build_walls_other',
        ),
        migrations.RemoveField(
            model_name='demographiccharacteristic',
            name='radio',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('an_iron', models.CharField(choices=[('yes_electrical', 'Yes electrical'), ('yes_charcoal_iron', 'Yes charcoal iron'), ('no', 'No')], max_length=45, verbose_name='Do you have an Iron in your household?')),
                ('bank_account', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Does anyone in your household own a bank account/mobile money/microfinance?')),
                ...
                ('main_power_source', models.CharField(choices=[('electricity', 'Electricity'), ('battery_torch', 'Battery/ torch '), ('solar_energy', 'Solar energy'), ('kerosene', 'Kerosene'), ('OTHER', 'Others')], max_length=15, verbose_name='What is the main source of power lighting in your household?')),
