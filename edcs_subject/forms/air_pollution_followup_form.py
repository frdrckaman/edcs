...
class AirPollutionFollowupFormValidator(FormValidator):
    def clean(self):
        ...
        self.required_if(OTHER, field="fuel_type_used", field_required="fuel_type_used_other")
        self.required_if(OTHER, field="stove_type_used", field_required="stove_type_used_other")
