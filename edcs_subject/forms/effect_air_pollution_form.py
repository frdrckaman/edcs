...
class EffectAirPollutionFormValidator(FormValidator):
    ...
    def clean(self):
        ...
        self.applicable_if(YES, field="family_member_sickness", field_applicable="who_had_illness")
        self.required_if(YES, field="family_member_sickness", field_required="fuel_before_changing")
        self.required_if(YES, field="variation_btn_fuel", field_required="influence_variation_btn_fuel")
