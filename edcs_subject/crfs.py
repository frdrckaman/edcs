...
crfs_d1 = FormsCollection(
    ...
    Crf(show_order=140, model="edcs_subject.lungcancerlabinvestigation", required=False),
    ...
    Crf(show_order=150, model="edcs_subject.contraceptiveusereproductivehistory", required=False),
