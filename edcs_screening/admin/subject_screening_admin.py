...
class SubjectScreeningAdmin(ModelAdminDashboardMixin, SimpleHistoryAdmin):
    ...
    radio_fields = {
        ...
        "other_cancer_dx": admin.VERTICAL,
        ...
        "tb_pleurisy": admin.VERTICAL,
        "dx_tb_clinical_criteria": admin.VERTICAL,
        "ct_findings_report": admin.VERTICAL,
