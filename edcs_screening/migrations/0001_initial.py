    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_category', models.CharField(choices=[('lung_cancer_suspect', 'Lung cancer suspect'), ('other_cancers', 'Other cancers'), ('cancer_free', 'Cancer free')], max_length=45, verbose_name='')),
