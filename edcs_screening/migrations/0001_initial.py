# Generated by Django 3.1.7 on 2021-11-15 14:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=50, verbose_name='Region:')),
                ('district', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=50, verbose_name='District:')),
                ('patient_know_dob', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=50, verbose_name='Patients hospital identification number:')),
                ('patient_dob', models.DateTimeField(editable=False, null=True, verbose_name='What is patient date of birth?')),
                ('hospital_id', models.CharField(max_length=50, verbose_name='Patients hospital identification number:')),
                ...
                ('family_diagnosed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Has any member of your family been diagnosed with either breast cancer, colon cancer, lung cancer, ovarian cancer, prostate cancer, thyroid or uterine cancer?')),
